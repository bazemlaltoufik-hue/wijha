        ...
        <div className="grid grid-cols-1 gap-y-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {trendingJobs.map((job) => (
              <div
                key={job.id}
                className={`relative ${job.color} border-2 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1`}
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-14 h-14 bg-white rounded-xl shadow-md flex items-center justify-center text-2xl">
                  ...
                  <Bookmark className="w-5 h-5 text-gray-400 hover:text-gray-700 cursor-pointer transition-colors" />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="py-2 px-6e rounded-lg font-semibold text-white transition-all duration-200 bg-blue-600 hover:bg-blue-700 active:bg-blue-80">
                    Apply Now
                  </button>
                </div>
              </div>
